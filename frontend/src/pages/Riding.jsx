...
const Riding = () => {
    return (
        <div className='h-screen'>
            ...
            <Link to="/home2" className="fixed right-2 top-2 flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-lg transition-all hover:scale-110 hover:shadow-xl">
                <i className="text-2xl text-gray-800 ri-home-2-line"></i>
            </Link>
            ...
            <div className='h-1/2'>
                ...
                <button className='w-full bg-green-600 text-white font-semibold rounded-lg p-2 mr-3  mt-5'>Make a Payment</button>
            </div>
        </div>
    )
}
